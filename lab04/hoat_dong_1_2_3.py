...
#set không cho phần tử trùng lặp vì set là một tập hợp các phần tử duy nhất, trong khi dictionary cho phép các key trùng lặp nhưng giá trị của chúng có thể khác nhau.
